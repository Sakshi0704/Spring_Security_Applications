...
@RestController
//@RequestMapping("/jpa")
// @CrossOrigin(origins = "http://localhost:4200") // to any specific domain can access this
// @CrossOrigin(origins = "*") // any domain on which front is running can access this api 
